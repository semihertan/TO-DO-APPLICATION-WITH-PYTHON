...
set_default_color_theme(str(resource_path("assets", "themes", "NightTrain.json")))

database.initialize_db()

login_bg_data = Image.open(resource_path("assets", "images", "login_bg.jpg"))
username_icon_data = Image.open(resource_path("assets", "images", "username_icon.png"))
password_icon_data = Image.open(resource_path("assets", "images", "password_icon.png"))
...
def main_window(username):
    ...
    # logo icon
    logo_img_data = Image.open(resource_path("assets", "images", "logo.jpeg"))
    ...
    # account button
    person_img_data = Image.open(resource_path("assets", "images", "person_icon.png"))
    ...
    list_img_data = Image.open(resource_path("assets", "images", "list_icon.png"))
    ...
    # calendar button
    returns_img_data = Image.open(resource_path("assets", "images", "calendar_icon.png"))
    ...
    # settings butonu
    settings_img_data = Image.open(resource_path("assets", "images", "settings.png"))
    ...
    # right background
    right_bg_image_data = Image.open(resource_path("assets", "images", "main_bg.png"))
    ...
    # add task button
    add_img = Image.open(resource_path("assets", "images", "add_icon.png")).convert("RGBA")
    ...
    # remove task button
    remove_img = Image.open(resource_path("assets", "images", "trash_icon.png")).convert("RGBA")
    ...
    # task status icon
    tik_image_data = Image.open(resource_path("assets", "images", "status_icon.png"))
    ...
    # Success icon
    success_image_data = Image.open(resource_path("assets", "images", "success.png"))
    ...
    pygame.mixer.init()
    pygame.mixer.music.load(str(resource_path("assets", "sounds", "success_bell-6776.mp3")))
    ...
    def add_task_window():
        ...
        normal_star_image_data = Image.open(resource_path("assets", "images", "normal_star.png"))
        favorite_image_data = Image.open(resource_path("assets", "images", "favorite_star.png"))
        ...
        def open_reminder_picker():
            ...
            # Saat ve dakika seÃ§enekleri
            hour_var = StringVar(value="09")
            minute_var = StringVar(value="00")

            hour_options = [f"{h:02}" for h in range(24)]
            minute_options = [f"{m:02}" for m in range(0, 60, 5)]  # 5 dakikalÄ±k artÄ±ÅŸlarla
        ...
        # Eski reminder menÃ¼ye bu seÃ§eneÄŸi ekliyoruz
